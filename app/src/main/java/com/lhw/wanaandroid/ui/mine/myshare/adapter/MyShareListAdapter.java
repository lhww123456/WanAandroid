package com.lhw.wanaandroid.ui.mine.myshare.adapter;
...
public class MyShareListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private  RecyclerView recyclerView;
    private  Context context;
    private  List<ArticleDetail> articles;
    private  OnItemClickListener mListener;

    public MyShareListAdapter(RecyclerView recyclerView, Context context, List<ArticleDetail> question) {
        this.context = context;
        this.recyclerView = recyclerView;
        this.articles = question;
    }

    public void setShareArticleData(List<ArticleDetail> data) {
//        this.articles.clear();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ArticleDetail datasBean = articles.get(position);
        ShareViewHolder viewHolder2 = (ShareViewHolder) holder;
    ...
    public void onClick(View v) {
        if (mListener != null){
            ...
            mListener.onItemClick(articles.get(position));
        }
    }
